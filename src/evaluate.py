...
def main():
    ...
    # If model_path is a LoRA adapter directory, keep the base model name from config
    # and apply the adapter on top. Otherwise treat it as the full model (HF ID or local dir).
